...
int main()
{
    ...
    // ------------------------------------
    Shader objectShader("src/shaderfile/objectShader.vs", "src/shaderfile/objectShader.fs");
    Shader lightShader("src/shaderfile/lightShader.vs", "src/shaderfile/lightShader.fs");
